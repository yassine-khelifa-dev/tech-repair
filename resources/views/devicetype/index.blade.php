...
@endif
 ...
 <a href="{{  route('devicetype.create') }}" class="rounded-md bg-green-500 px-3 py-2 text-sm font-semibold text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                     ...
                     <td class="px-6 py-4">
                      <a href="{{ route('devicetype.edit', $devicetype->id) }}"
                       ...
                       <form action="{{  route('devicetype.destroy',    $devicetype->id ) }}" method="post">
                        @csrf
                        @method('DELETE')
                        <button type="submit" onclick="return confirm('Are you sure to delete this device type? ') " class="rounded-md bg-orange-500 px-3 py-2 text-sm mt-2 font-semibold text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
