...
<form action="{{  route('brand.store') }}" method="POST">
 ...
 <div class="border-b border-white/10 pb-12">
    <h2 class="text-base/7 font-semibold text-white">Create new a brand</h2>
...
<a  href="{{  route('brand.index') }}" type="button" class="text-sm/6 font-semibold text-white">Cancel</a>
