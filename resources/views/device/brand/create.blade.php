        ...
        <div class="overflow-hidden rounded-xl border border-white/10 bg-gray-800/70 shadow-2xl shadow-black/20">
            <div class="border-b border-white/10 px-6 py-5">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-sm font-semibold uppercase tracking-wide text-blue-300">New brand</p>
                        <h1 class="mt-1 text-2xl font-bold text-white">Create Brand</h1>
                    </div>
                </div>
                <p class="mt-4 text-sm leading-6 text-gray-400">
                    Add a device brand name that can be reused when creating models and repair records.
                </p>
            </div>

            <form action="{{ route('brand.store') }}" method="POST" class="px-6 py-6">
                @csrf
