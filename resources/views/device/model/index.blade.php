...
@section('content')
    <div x-data="{ modal: false, model_selected: null }" class="mx-auto max-w-7xl">
        ...
        <div
            ...
            <div class="grid gap-2 text-sm text-gray-300 sm:grid-cols-2 lg:grid-cols-4 md:grid-cols-1">
                <div class="rounded-lg border border-white/10 bg-gray-950/30 px-3 py-2">
                    <span class="font-semibold text-purple-200">Configure</span> selects allowed options.
                </div>
                <div class="rounded-lg border border-white/10 bg-gray-950/30 px-3 py-2">
                    <span class="font-semibold text-emerald-200">View</span> shows model details.
                </div>
                <div class="rounded-lg border border-white/10 bg-gray-950/30 px-3 py-2">
                    <span class="font-semibold text-blue-200">Edit</span> changes model information.
                </div>
                <div class="rounded-lg border border-white/10 bg-gray-950/30 px-3 py-2">
                    <span class="font-semibold text-red-200">Delete</span> removes the model.
                </div>
            </div>
        </div>
