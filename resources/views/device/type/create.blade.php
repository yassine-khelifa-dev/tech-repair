        ...
        <div class="overflow-hidden rounded-xl border border-white/10 bg-gray-800/70 shadow-2xl shadow-black/20">
            <div class="border-b border-white/10 px-6 py-5">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-sm font-semibold uppercase tracking-wide text-blue-300">New device type</p>
                        <h1 class="mt-1 text-2xl font-bold text-white">Create Device Type</h1>
                    </div>
                </div>
                <p class="mt-4 text-sm leading-6 text-gray-400">
                    Add a type such as smartphone, tablet, laptop, or console to classify repair devices.
                </p>
            </div>

            <form action="{{ route('devicetype.store') }}" method="POST" class="px-6 py-6">
                @csrf
