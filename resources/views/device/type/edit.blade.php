        ...
        <div class="overflow-hidden rounded-xl border border-white/10 bg-gray-800/70 shadow-2xl shadow-black/20">
            <div class="border-b border-white/10 px-6 py-5">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-sm font-semibold uppercase tracking-wide text-blue-300">Type settings</p>
                        <h1 class="mt-1 text-2xl font-bold text-white">Edit Device Type</h1>
                    </div>
                </div>
                <p class="mt-4 text-sm leading-6 text-gray-400">
                    Update this device type name. Related device models will continue to use this type.
                </p>
            </div>

            <form action="{{ route('devicetype.update', $devicetype->id) }}" method="POST" class="px-6 py-6">
                @csrf
                @method('PUT')

                <div>
                    <label for="name" class="block text-sm font-semibold text-gray-200">Device type name</label>
                    <div class="relative mt-2">
                        ...
                        <input id="name"
                            ...
                            name="name"
                            autocomplete="off"
                            placeholder="Example: Smartphone, Tablet, Laptop"
