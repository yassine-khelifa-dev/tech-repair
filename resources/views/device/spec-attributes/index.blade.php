                        ...
                        <th scope="row" class="px-6 py-4 font-medium text-heading whitespace-nowrap">
                            <div class="flex flex-col gap-2">
                                ...
                                @if ($spc_attribute->deviceTypes->count() > 3)
                                    <button @click="modal = true; model_selected = {{ Js::from($spc_attribute) }} " class="text-xs font-medium text-gray-400">
                        ...
                        <th>
                            <ul>
                                ...
                                @if ($spc_attribute->specOptions->count() > 3)
                                    <button @click="modal = true; model_selected = {{ Js::from($spc_attribute) }} "  class="pl-4 text-xs font-medium text-indigo-400">
