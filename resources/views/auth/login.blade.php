    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <div>
            ...
            <input id="email"
                ...
                type="email" name="email" value="{{ old('email', 'tech-repair-admin@eprostam.com') }}" required
        ...
        <div>
            ...
            <input id="password"
                class="mt-2 block w-full rounded-md border border-white/10 bg-gray-950/70 px-4 py-3 text-white shadow-sm outline-none transition placeholder:text-gray-500 focus:border-cyan-300 focus:ring-2 focus:ring-cyan-300/30"
                type="password" name="password" value="TechRepair2026!" required autocomplete="current-password"
        ...
        <div class="flex items-center justify-between gap-4">
            ...
            @if (Route::has('password.request'))
                <a class="text-sm font-semibold text-cyan-300 transition hover:text-cyan-200 focus:outline-none focus:ring-2 focus:ring-cyan-300 focus:ring-offset-2 focus:ring-offset-gray-950"
